    ...
    public partial class admin_agregar_form : Form
    {
        ...
        private async void btnConfirmar_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(acumuladorErrores))
            {
                ...
                Usuario usuario = new Usuario(id, txNombre, txApellido, txDireccion, txTelefono, txEmail, DateTime.Now, datetimeTxFechaNac, DateTime.Now, DateTime.Now, txNombreUsuario, intCmTipoUsuario, intTxDNI, txContraseña, host);
